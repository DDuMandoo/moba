        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.infoBox}>
            ...
            <View style={styles.galleryBox}>
              ...
              <TouchableOpacity onPress={() => router.push(`/promises/${id}/gallery`)}>
                <FlatList
                  horizontal
                  data={images}
            ...
            <View style={styles.placeListBox}>
              ...
              <Text style={styles.subText}>약속에서 방문했던 장소들을 확인해보세요.</Text>
...
const styles = StyleSheet.create({
  ...
  headerImage: { width: '100%', height: TOP_IMAGE_HEIGHT },
  headerOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(233,217,197,0.7)' },
  headerButtons: { flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 20, position: 'absolute', width: '100%' },
  headerRightButtons: { flexDirection: 'row', gap: 10 },
  iconButton: { borderWidth: 1, borderColor: Colors.primary, borderRadius: 8, padding: 4 },
  whiteBox: {
    position: 'absolute',
  ...
  infoBox: { paddingHorizontal: 20, paddingTop: 12 },
  title: { fontSize: 24, fontWeight: '500', color: Colors.primary, marginBottom: 8 },
  detailRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 8 },
  detailText: { fontSize: 16, color: Colors.primary },
  galleryBox: { marginTop: 16 },
  galleryTitle: { fontSize: 18, fontWeight: 'bold', color: Colors.black, marginLeft: 20, marginBottom: 8 },
  ...
  subText: { fontSize: 14, color: Colors.grayDarkText },
  toastContainer: {
    position: 'absolute',
    alignItems: 'center',
  ...
  toastText: { fontSize: 10, color: Colors.primary },
});
